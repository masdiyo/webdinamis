...
<html>
<head>
	<title>Contoh Penggunaan Explode</title>
</head>
<body>
<?php
	...
	echo "<p>";
	echo "<h3>Penerapan Explode [2] - <em><strong>Pembacaan TNKB</strong></em></h3>";
	$tnkb = "AB 3079 OG";
	...
	echo "<p>";
	echo "<h3>Penerapan Explode [3] - <em><strong>Pembacaan Kode NPWP</strong></em></h3>";
	...
	echo "<p>";
	echo "<h3>Penerapan Explode [4] - <em><strong>Pengambilan tag pencarian</strong></em></h3>";
	...
	echo "<h3>Penerapan Explode [5] - <em><strong>Penomoran Kode Nomor Surat</strong></em></h3>";
	...
	echo "<h3>Penerapan Explode [6] - <em><strong>Penomoran Kode Inventaris / Aset</strong></em></h3>";
